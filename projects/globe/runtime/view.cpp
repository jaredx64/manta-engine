...
{
	// Pick
	double_r3 pickRay = ray_screen_point_to_world_perspective( double_v2 { Mouse::x(), Mouse::y() },
		double_v2 { Window::width, Window::height }, View::position, View::matrixView, View::matrixPerspective );
