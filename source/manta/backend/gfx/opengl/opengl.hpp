...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	#if SWAPCHAIN_DEPTH_FORMAT == GfxDepthFormat_R32_FLOAT
		constexpr int bitsDepth = 24; // TODO: 32-bit depth not working on Linux
		constexpr int bitsStencil = 8;
	#elif SWAPCHAIN_DEPTH_FORMAT == GfxDepthFormat_R24_UINT_G8_UINT
		constexpr int bitsDepth = 24;
		constexpr int bitsStencil = 8;
	#else
		static_assert( false, "Unsupported swapchain depth format!" );
	#endif
#else
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	#define nglBlendFuncSeparate glBlendFuncSeparate
	#define nglBlendEquationSeparate glBlendEquationSeparate
...
extern "C"
{
	...
	GL_EXTERN void GL_API glFrontFace( GLenum );
